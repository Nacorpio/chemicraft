...
public class PeriodicCraft {
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		*/
		...
		new Element(18, "Argon", "Ar", "Colorless", 39.948F, -185.34F,
				-189.34F, 6.53F, 1.784F, Element.CATEGORY.NOBLE_GASES,
				Element.STATE.GAS);
		new Element(22, "Titanium", "Ti", "Silvery", 47.867F, 3287.0F,
				1668.0F, 223.80F, 4.506F, Element.CATEGORY.TRANSITION_METALS,
				Element.STATE.SOLID);
		new Element(23, "Vanadium", "V", "Silverish", 50.942F, 3380.0F,
				1890.0F, 233.794F, 6.0F, Element.CATEGORY.TRANSITION_METALS,
				Element.STATE.SOLID);
		new Element(24, "Chromium", "Cr", "Gray", 51.996F, 2670.0F, 1857.0F,
				347.0F, 7.19F, Element.CATEGORY.TRANSITION_METALS,
				Element.STATE.SOLID);
		new Element(25, "Manganese", "Mn", "Silvery Gray", 54.940F, 1962.0F,
				1245.0F, 221.0F, 7.21F, Element.CATEGORY.TRANSITION_METALS,
				Element.STATE.SOLID);
		
		
		new Element(27, "Cobalt", "Co", "Metallic Gray", 58.933F, 2927.0F,
				1495.0F, 198.520F, 8.90F, Element.CATEGORY.TRANSITION_METALS,
				Element.STATE.SOLID);
		new Element(28, "Nickel", "Ni", "Gray Gold", 58.693F, 2730.0F,
				1455.0F, 199.570F, 8.908F, Element.CATEGORY.TRANSITION_METALS,
				Element.STATE.SOLID);
		new Element(29, "Copper", "Cu", "Red Orangy", 63.546F, 2562.0F,
				1084.62F, 158.180F, 8.96F ,Element.CATEGORY.TRANSITION_METALS,
				Element.STATE.SOLID);
		new Element(30, "Zinc", "Zn", "Silvery Greyish White", 65.380F,
				907.0F, 419.530F, 60.555F, 7.14F,
				Element.CATEGORY.TRANSITION_AND_POST_TRANSISTION_METALS,
				Element.STATE.SOLID);
		new Element(80, "Mercury", "Hg", "Gray", 13.534F, 200.592F, 356.73F,
				-38.8290F, 59.11F, Element.CATEGORY.TRANSITION_METALS,
